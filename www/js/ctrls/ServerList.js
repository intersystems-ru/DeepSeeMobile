         ...
         */
         ...
         if (servers) {
            ...
            for (var i = 0; i < servers.length; i++) {
                ...
                var $item = $('<li id="itemServer' + idx + '" class="table-view-cell">' + servers[i].ip + '<button id="btnEditServer' + idx + '" class="btn"><span class="icon icon-edit"></span>Edit</button><button id="btnDeleteServer' + idx + '" class="btn btn-negative" style="display:none"><span class="icon icon-trash"></span>Delete</button></li>');
